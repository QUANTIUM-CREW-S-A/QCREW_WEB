...
export function Partners() {
  ...
  return (
    <section className="py-16 bg-rack-paper border-y border-rack-rule overflow-hidden relative">
      <div className="absolute inset-0 bg-gradient-to-r from-transparent via-rack-link/5 to-transparent" />
      ...
      <div className="absolute left-0 top-0 bottom-0 w-32 bg-gradient-to-r from-rack-paper to-transparent z-10" />
      <div className="absolute right-0 top-0 bottom-0 w-32 bg-gradient-to-l from-rack-paper to-transparent z-10" />
    </section>
  );
}
