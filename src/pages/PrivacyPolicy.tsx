    ...
    <SectionWrapper className="pt-32 pb-20">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="prose prose-invert prose-lg max-w-none text-brand-muted">
          ...
          <h3 className="text-white text-2xl font-bold mt-8 mb-4">{t("privacy.section1.title")}</h3>
          <p>
          ...
          <h3 className="text-white text-2xl font-bold mt-8 mb-4">{t("privacy.section2.title")}</h3>
          <p>
          ...
          <h3 className="text-white text-2xl font-bold mt-8 mb-4">{t("privacy.section3.title")}</h3>
          <p>
          ...
          <h3 className="text-white text-2xl font-bold mt-8 mb-4">{t("privacy.section4.title")}</h3>
          <p>
            {t("privacy.section4.content")}
          </p>

          <h3 className="text-white text-2xl font-bold mt-8 mb-4">{t("privacy.section5.title")}</h3>
          <p>
